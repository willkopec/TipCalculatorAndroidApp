...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calculateTipBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if((billTotalInput.getText().toString() != "" && isNumeric(billTotalInput.getText().toString())) && (percentageTipInput.getText().toString() != "" && isNumeric(percentageTipInput.getText().toString()))){
                    ...
                    Intent tipAmountPage = new Intent(MainActivity.this, TipSplitActivity.class);
                    ...
                    Toast.makeText(MainActivity.this, "Please fill in all of the fields. (Bill Total and Tip Percentage)",
                            Toast.LENGTH_LONG).show();
                } else if (!isNumeric(billTotalInput.getText().toString()) || !isNumeric(percentageTipInput.getText().toString())){
                    Toast.makeText(MainActivity.this, "Bill Total and Tip Percentage must be valid numbers (No percents or dollar signs)",
                            Toast.LENGTH_LONG).show();
                }
            }
        });

        Button roundTipBtn = findViewById(R.id.roundTipButton);
        ...
        roundUpHelper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(MainActivity.this, "This will round the tip up to the nearest dollar amount",
                        Toast.LENGTH_LONG).show();
            }
        });
    }
